...
class Tree(object):
    ...
    # change node and line color of this tree
    # avoid changing color after having nodes or lines

    def change_color(self, node_color, line_color):
        self.node_color = node_color
        self.line_color = line_color

    # return a new node at (x, y)
    def new_node(self, x, y):
        return shapes.TreeNode(x, y, self.node_color, self.screen, self.node_num)
    ...
    def draw_tree(self):
        # print("At this frame, # of nodes = {}".format(self.node_num))
        for node in self.nodes:
            # print("node {} color is {}".format(node.get_id(), node.color))
            node.draw()
    ...
    def large_tree_nodes(self):
        positions = [(15, 1), (12, 4), (18, 4), (9, 7), (15, 7), (21, 7), (6, 10), (
